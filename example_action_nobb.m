...
% create results file
fid=fopen(sprintf(VOCopts.action.respath,'comp11',cls),'w');
...
% trivial feature extractor: reference point of person in image (!)
function fd = extractfd(VOCopts,obj)

fd=[obj.point.x ; obj.point.y];
